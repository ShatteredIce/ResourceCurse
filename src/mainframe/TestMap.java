...
public class TestMap extends Map {
	...
	public TestMap() {
		...
		territories.add(new Territory(1, 0, 255, 0, 0));
		territories.add(new Territory(2, 1, 0, 125, 125));
		territories.add(new Territory(3, 0, 125, 0, 0));
		territories.add(new Territory(4, 0, 0, 0, 125));
		territories.add(new Territory(5, 0, 0, 0, 255));
